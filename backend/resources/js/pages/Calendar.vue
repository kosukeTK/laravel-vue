  ...
  <div class="content">
    ...
    <div class="calendar">
      ...
      <div class="calendar-weekly" v-for="(week, index) in calendars" :key="index">
        <div class="calendar-daily" :class="{ outside: currentMonth !== day.month }" v-for="(day, index) in week" :key="index" @click="albumUpload(currentMonth, day.day)">
